...
export const metadata: Metadata = {
  title: "Catalogue",
  description:
    "Plafonniers LED et appliques murales en stock à Alger : filtrez par catégorie, gamme et prix.",
};
  ...
  return (
    <main className="mx-auto max-w-7xl px-2 py-10 background md:py-14">
      ...
      <p className="mt-3 max-w-xl text-ink-soft">
        Tous les produits d&apos;éclairage disponibles en magasin, avec leur
        prix. Commandez en ligne, retirez à Tixeraine ou faites-vous livrer.
      </p>
