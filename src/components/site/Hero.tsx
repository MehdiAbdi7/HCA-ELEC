    ...
    >
      <div className="mx-auto grid max-w-6xl gap-12 px-5 py-10 md:grid-cols-2 md:items-center md:py-16">
        ...
        <div className="relative">
          ...
          {/* La photo source est carrée (1080x1080) : le conteneur doit
              matcher ce ratio, sinon object-cover recadre et coupe le haut
              de l'enseigne (c'était le bug avec aspect-4/3). */}
